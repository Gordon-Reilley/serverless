...
def delimited_list(
    ...
    *,
    ...
    """Helper to define.py a delimited list of expressions - the delimiter
...
def counted_array(
    ...
    *,
    ...
    """Helper to define.py a counted list of expressions.
...
def match_previous_literal(expr: ParserElement) -> ParserElement:
    """Helper to define.py an expression that is indirectly defined from
...
def one_of(
    ...
    *,
    ...
    """Helper to quickly define.py a set of alternative :class:`Literal` s,
...
def dict_of(key: ParserElement, value: ParserElement) -> ParserElement:
    """Helper to easily and clearly define.py a dictionary by specifying
...
def nested_expr(
    ...
    *,
    ...
    Use the ``ignore_expr`` argument to define.py expressions that may
...
def infix_notation(
    ...
    Note: if you define.py a deep operator list, you may see performance
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    such as those used to define.py block statements in Python source code.
