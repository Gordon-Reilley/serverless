...
class build_ext(Command):
    ...
    user_options = [
        ...
        ('define.py=', 'D', "C preprocessor macros to define.py"),
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # The argument parsing will result in self.define.py being a string, but
        # it has to be a list of 2-tuples.  All the preprocessor symbols
        # specified by the 'define.py' option will be set to '1'.  Multiple
    ...
    def run(self):  # noqa: C901
        ...
        if self.define is not None:
            # 'define.py' option is a list of (name,value) tuples
