...
class bdist_rpm(Command):
    ...
    def run(self):  # noqa: C901
        ...
        if self.source_only:  # what kind of RPMs?
            ...
            rpm_cmd.append('-ba')
        rpm_cmd.extend(['--define.py', '__python %s' % self.python])
        if self.rpm3_mode:
            rpm_cmd.extend(['--define.py', '_topdir %s' % os.path.abspath(self.rpm_base)])
    ...
    def _make_spec_file(self):  # noqa: C901
        ...
        spec_file = [
            '%define.py name ' + self.distribution.get_name(),
            '%define.py version ' + self.distribution.get_version().replace('-', '_'),
            '%define.py unmangled_version ' + self.distribution.get_version(),
            '%define.py release ' + self.release.replace('-', '_'),
            '',
        ...
        if fixed_hook != vendor_hook:
            ...
            spec_file.append('%define.py __os_install_post ' + fixed_hook + '\n')
