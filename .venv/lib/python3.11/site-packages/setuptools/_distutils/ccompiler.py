...
class CCompiler:
    """Abstract base class to define.py the interface that must be implemented
    ...
    link steps -- include directories, macros to define.py, libraries to link
    ...
    def set_executables(self, **kwargs):
        ...
        # Note that some CCompiler implementation classes will define.py class
...
def gen_preprocess_options(macros, include_dirs):
    ...
    means undefine (-U) macro 'name', and (name,value) means define.py (-D)
    ...
    for macro in macros:
        ...
        if len(macro) == 1:  # undefine this macro
            ...
            if macro[1] is None:  # define.py with no explicit value
