...
class Command:
    ...
    def __init__(self, dist):
        ...
        # Some commands define.py a 'self.force' option to ignore file
        # timestamps, but methods defined *here* assume that
        # 'self.force' exists for all commands.  So define.py it here
        # just to be safe.
        self.force = None
    ...
    def copy_file(
        ...
        the latter defaults to false for commands that don't define.py it.)"""
